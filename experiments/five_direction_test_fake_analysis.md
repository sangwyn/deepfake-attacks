...
Per-direction configurations and outputs are under:

```text
experiments/direction1/test_fake_full.yaml/.json
experiments/direction2/test_fake_full.yaml/.json
experiments/direction3/test_fake_full.yaml/.json
experiments/direction4/test_fake_full.yaml/.json
experiments/direction5/test_fake_full.yaml/.json
```

Machine-readable summaries:

```text
experiments/five_direction_test_fake_summary.json
experiments/five_direction_test_fake_summary.csv
experiments/five_direction_test_fake_analysis.md
```
